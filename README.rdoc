...
The bars are based on a fixed dataset from a list of licensed taverns in Chicago. The Haversine formula is used to calculate distances between each bar.
```
